<div class="modal fade bs-example-modal-lg newReport coment{{$comment->comentario_id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        ...
        <div class="modal-content">
            ...
            <form role="form"  method="POST" action="/report" accept-charset="UTF-8" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Denuncia do Comentário: {{$comment->comentario_id}}</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="comentario_id" id="comentario_id" class="form-control" value="{{$comment->comentario_id}}" required="required" title="">
