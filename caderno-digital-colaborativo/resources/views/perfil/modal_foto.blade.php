        ...
        <div class="modal-content">
            ...
            <form role="form"  method="POST" action="/perfil/trocarFoto" accept-charset="UTF-8" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modificar foto</h4>
                </div>

                <div class="modal-body">
                    <label for="midia" class="col-sm-2">Foto</label>
                    <input type="file" name="foto" id="foto" class="form-control-file" value="" required="required" title="">
